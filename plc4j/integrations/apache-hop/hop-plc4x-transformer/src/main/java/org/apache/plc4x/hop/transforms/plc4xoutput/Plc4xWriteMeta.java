...
@Transform(
        id = "plc4x-write",
        name = "i18n::Plc4x.Write.Name",
        description = "i18n::Plc4x.Write.Description",
...
public class Plc4xWriteMeta extends BaseTransformMeta implements ITransformMeta<Plc4xWrite, Plc4xWriteData> {
