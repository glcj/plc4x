...
>>>>>>> develop:plc4j/drivers/s7/src/main/java/org/apache/plc4x/java/s7/readwrite/field/S7SslField.java
   ...
   //SZL_ID=0xYYYY;INDEX=0xZZZZ
    ...
    public S7SzlField(int szlId, int index) {
        this.szlId = szlId;
        this.index = index;
    }
    ...
    public static boolean matches(String fieldString) {
        return SZL_ADDRESS_PATTERN.matcher(fieldString).matches();      
    }   
    
    public static S7SzlField of(String fieldString) {
        Matcher matcher = SZL_ADDRESS_PATTERN.matcher(fieldString); 
        if (matcher.matches()){
            ...
            return new S7SzlField(Integer.parseInt(strSxlId, 16),Integer.parseInt(strIndex, 16));
        }  
