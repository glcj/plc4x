...
public class S7ProtocolLogic extends Plc4xProtocolBase<TPKTPacket> {
    ...
    public static final Duration REQUEST_TIMEOUT = Duration.ofMillis(120000);
    ...
    */
    ...
    DefaultPlcReadRequest pingfieldrequest = null;    
    ...
    */
    ...
    public CompletableFuture<PlcReadResponse> read(PlcReadRequest readRequest) {
        ...
        if (request.getFields().get(0) instanceof S7SzlField) {
            ...
            final S7MessageUserData s7SslMessageRequest = new S7MessageUserData(1, new S7ParameterUserData(Arrays.asList(
            ...
            for (String fieldName : request.getFieldNames()) {
                ...
                switch(field.getFieldtype()){
                    case EVENT_SUBSCRIPTION: {
                        ...
                        txParameters = new S7ParameterUserData(parameterItems);
                        txPayloads = new S7PayloadUserData(payloadItems, null);
                    ...
                    case CYCLIC_UNSUBSCRIPTION:{
                        logger.info("CYCLIC_UNSUBSCRIPTION");
    ...
    private void encodeCycledS7ANYSubscriptionRequest(PlcSubscriptionField plcfield,
        ...
        //List<CycServiceItemAnyType> items = new CycServiceItemAnyType[s7field.getS7field().length];
        List<CycServiceItemType> items = new ArrayList();
        int i=0;
        for (S7Field userfield:s7field.getS7field()){
            items.add(i, new CycServiceItemAnyType(
                    (short) 0x0a,
                    (short) 0x10, //S7ANY
    ...
    private TPKTPacket createIdentifyRemoteMessage() {
        S7MessageUserData identifyRemoteMessage = new S7MessageUserData(1, new S7ParameterUserData(Arrays.asList(
                new S7ParameterUserDataItemCPUFunctions((short) 0x11, (byte) 0x4, (byte) 0x4, (short) 0x01, (short) 0x00, null, null, null)
        )), new S7PayloadUserData(Arrays.asList(
                new S7PayloadUserDataItemCpuFunctionReadSzlRequest(DataTransportErrorCode.OK, 
                        DataTransportSize.OCTET_STRING, 
    ...
    */
    ...
    /*
    * TODO: Ping service. Check RFC905, section 13.5.
    *       Why the CP close the connection when recived this packed?
    */
    private COTPDataAcknowledgement createCOTPDataAcknowledgement(int calledTsapId, int callingTsapId, COTPTpduSize cotpTpduSize) {
        return new COTPDataAcknowledgement(
            null, null, (short) callingTsapId, (int) 0x00000000, (short) 0x0001, null);
    }    
                        ...
                        try {
                            ...
                            if (parameteritem.getLastDataUnit() == 1) {
                                ...
                                if (msg != null) {
                                    ...
                                    S7PayloadUserDataItemCpuFunctionReadSzlResponse payloadItem2 = (S7PayloadUserDataItemCpuFunctionReadSzlResponse) payload2.getItems().get(0);
    ...
    */
    ...
    static class TransactionErrorCallback<T, E extends Throwable> implements Consumer<TimeoutException>, BiConsumer<TPKTPacket, E> {
        ...
        public void accept(TimeoutException e) {
            System.out.println("Transaction TimeoutException: " + e.toString());
            transaction.endRequest();
        ...
        public void accept(TPKTPacket tpktPacket, E e) {
            System.out.println("Transaction TPKTPacket: " + e.toString());            
            transaction.endRequest();
            future.completeExceptionally(e);
        }
    }
