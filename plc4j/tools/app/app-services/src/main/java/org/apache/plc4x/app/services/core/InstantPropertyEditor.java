...
@PropertyEditorRegistration(targetType = Instant.class)
public class InstantPropertyEditor extends PropertyEditorSupport implements ExPropertyEditor {
