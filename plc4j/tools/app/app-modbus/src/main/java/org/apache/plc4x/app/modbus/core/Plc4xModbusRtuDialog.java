...
@ServiceProvider(service=JDialog.class, path="Plc4xDriver/modbus-rtu")
public class Plc4xModbusRtuDialog extends JDialog implements Plc4xDialog {  
    
    public Plc4xModbusRtuDialog() {
     ...
     */
    public Plc4xModbusRtuDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Plc4xModbusRtuDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Plc4xModbusRtuDialog dialog = new Plc4xModbusRtuDialog(new javax.swing.JFrame(), true);
